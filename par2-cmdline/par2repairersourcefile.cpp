...
bool Par2RepairerSourceFile::ComputeTargetFileName(string path)
{
	//gm Double check to make sure we have a valid descriptionpacket
...
void Par2RepairerSourceFile::SetTargetFileName(string sTargetFilename)
{
