...
#ifndef SFX_MODULE
char* VolNameToFirstName(vector<string> *pvRarFiles, string sParfileName, const char *VolName,char *FirstName,bool NewNumbering)
{
  ...
  if (!FileExist(FirstName))
  {
    ...
    while (Find.Next(&FD))
    {
      Archive Arc(pvRarFiles, sParfileName);
