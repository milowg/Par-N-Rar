...
bool ReadTextFile(vector<string> *pvRarFiles, string sParfileName, char *Name,StringList *List,bool Config,bool AbortOnError,
				  bool ConvertToAnsi,bool Unquote,bool SkipComments)
{
	...
	Array<char> Data(sParfileName, ReadBlock+5);
	...
	if (IsUnicode((byte *)&Data[0],DataSize))
	{
		...
		Array<char> AnsiName(sParfileName);
