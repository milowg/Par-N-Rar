...
CDialogUtils::CDialogUtils(void)
{
}
...
void CDialogUtils::SetCheckbox(CWnd *pWnd, int nIdButton, bool bValue)
{
	if (bValue)
		pWnd->CheckDlgButton(nIdButton, BST_CHECKED);
	else
		pWnd->CheckDlgButton(nIdButton, BST_UNCHECKED);
}
